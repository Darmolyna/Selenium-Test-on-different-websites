...
public class Scope {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		// var footerLinksCount =
		// driver.findElements(By.xpath("//tr/td/ul/li/a")).size();
		...
		while (it.hasNext()) { // hasNext checks if it is available or not and it also returns boolean value
